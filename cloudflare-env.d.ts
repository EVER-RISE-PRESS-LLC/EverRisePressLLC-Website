/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 891f27b07dbc98831949a05399e72dde)
// Runtime types generated with workerd@1.20260815.1 2026-08-19 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	JWT_SECRET: string;
	WORKER_SELF_REFERENCE: Fetcher /* everrisepressllc-website */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "NEXT_PUBLIC_TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "JWT_SECRET">> {}
}
